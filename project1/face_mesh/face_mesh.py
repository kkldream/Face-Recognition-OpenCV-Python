...
class FaceMesh(object):
    ...
    def get_rotation(self, landmarks):
        ...
        roll = math.atan((right_eye_right_corner[1] - left_eye_left_corner[1])\
                / (right_eye_right_corner[0] - left_eye_left_corner[0]))\
                * 180 / math.pi
        yaw = (right_eye_right_corner[2] - left_eye_left_corner[2]) * 400
        pitch = (face_top[2] - between_mouth_nose[2]) * 400
